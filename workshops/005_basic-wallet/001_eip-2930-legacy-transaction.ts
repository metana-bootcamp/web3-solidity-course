...
async function main() {
  ...
  const keccak256Hash = keccak256(concatBytes(txTypeBytes(1), rlpEncode))
  ...
  const txRes = await axios.post(rpcUrl, {
    "jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [bytesToHex(concatBytes(txTypeBytes(1), rlpEncode1))], "id": 1
  })
...
// without access list : https://holesky.etherscan.io/tx/0x7c079fe29abbd577d731380b254ff0aa175d047ecd7c4748fd3b3dde62156ec9
// with access list : https://holesky.etherscan.io/tx/0x8cc859633313c95ee31a113b85c207ee2a0046cf697f118a4e62d92841922cf1