...
contract Uniswapper is ERC20 {
    ...
    function burn(uint256 _amountLP) external {
        _transfer(msg.sender, address(this), _amountLP);
        uint256 _amountA = (_amountLP * getTokenABalance()) / totalSupply();
        uint256 _amountB = (_amountLP * getTokenBBalance()) / totalSupply();
